...
try {
    ...
    if ([string]::IsNullOrWhiteSpace($result)) { throw 'Leere Antwort.' }
    Write-Output 'Reachable=True'
    exit 0
}
catch {
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBh02j4Tf+PAJcG
# 2Hk7tx9a6zwtNPCMu/57YsVpBxhyN6CCH/UwggWNMIIEdaADAgECAhAOmxiO+dAt
...
# 60v3whWaSXWWjruqy0o70SEwOfKivvd0boeVL/Ii+ZYwDQYJKoZIhvcNAQEBBQAE
# ggEAtnylBuSXsh1nwkHwDhm4YWWQ4nay8qDp467ojOtezDh670MHLrYjGb7QA6ME
# PMmXpFjwHwGULwWePur5YAHLNMg4b/m3Rdh8OeoAyAdipXNk4Ry17r9RFuy7NCMw
# ZPRuRMohsMtnj/iKRVAhlcDDKZf8H7pQkb3oVoyDXNADusYOP4Vgg1QJoUGzHo9Q
# oBmysAMXRGdj+kMK5GIEJtDdIKxdbqy2e5+VO6wjmIpNEQ9+sYwtVuk1laA29A1P
# 8ybtgDMJbRprT1yIT5JaYCuW81w9m6Wxgl/62E8A6pU0dLziDIES9KEDxrrpt6xY
# SDNb8WMcp5G5UwM8rATTtXy8ZqGCAyYwggMiBgkqhkiG9w0BCQYxggMTMIIDDwIB
...
# MTcxNDEzMzNaMC8GCSqGSIb3DQEJBDEiBCAxxZoYPFupsj2fXZCVOTxB0MOzqJtX
# Fjy+mrsvRjpuGDANBgkqhkiG9w0BAQEFAASCAgAQZIdbY5Z2CznyFu+nT1AP7gsG
# OarundFRirCdVu4vINTAvuigjtssdtCaqfkZijocfbpIg9S/86UrpZcahIZqN+pG
# PhHjWvmuI9vkx8PKEDIyP6PQwA2gHCtHRCUDN4ydMEniDrB2FmRhnTkukZ2wCyng
# 8aaT6riEuz0J9NHNIkHLGnaZCu+AdBu6ogStl8vRpR6YRVy5NJwPycFkQ2fiJyoP
# 5ES7Ppx6vEduEW6w02sRmI3WOkYoJLrvFs2A2q26cM8YM+YZ3jEF02rNdUBIyiqT
# 1663Tqgb9H+KFEZLmoGIZ6K3sCy0OPsF7xlG+tiq7rFXtW10AQ/yiEIOclB/ehLC
# p2lCshNxg1HpJWQl3JhH82uinmMYnR6JaHq3a9dez7fiF4vbVCp+7+NjcXfYLv7k
# hGvSnpKg7QNGHBEVwH0+tFoQCBoZ3dXu3pKsoSzJeATfCnGcdERHeZO8xrc/M3G4
# ST/ThP6xfAU+rR07z1U2u43re7z2kWyhM9vVcQvURlgbcJ/e5AXeQS8qWAl+7DU4
# e+gmuuxWD+TSF1mKAgxrXZX+SElmSsMB6tPwWCJstCedpyph1clt9X9x+wpd3yHl
# Cn4QzJ4lwNl0FhYL3XRtCb2htBHBug03x/rNAxpz5y3jaiR0GqxjXY6743SIgmp+
# 0viqd1VP9pqkcMUWrg==
